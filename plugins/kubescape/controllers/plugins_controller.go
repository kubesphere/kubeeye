...
import (
	...
	kubeeyev1alpha1 "github.com/kubesphere/kubeeye/plugins/kubescape/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=policy,resources=*,verbs=get;list
//+kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list
//+kubebuilder:rbac:groups=networking.k8s.io,resources=*,verbs=get;list
//+kubebuilder:rbac:groups="",resources=namespaces,verbs=get;list
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=*,verbs=get;list
//+kubebuilder:rbac:groups=admissionregistration.k8s.io,resources=*,verbs=get;list
...
func (r *PluginsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	kubeeyeServer := &kubeeyev1alpha1.Plugins{}

	err := r.Get(ctx, req.NamespacedName, kubeeyeServer)
	if err != nil {
	...
	err, kubescapeResults := pkg.KubescapeAudit(logs)
	if err != nil {
		logs.Error(err, "get kubehunter audit result failed")
	}

	logs.Info("write the result to the channel")
	pkg.KSResult = &kubescapeResults
