...
type AuditPlanInformer interface {
	...
	Lister() v1alpha1.AuditPlanLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeeyeV1alpha1().AuditPlans(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeeyeV1alpha1().AuditPlans(namespace).Watch(context.TODO(), options)
			},
		},
		&kubeeyev1alpha1.AuditPlan{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *auditPlanInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubeeyev1alpha1.AuditPlan{}, f.defaultInformer)
}

func (f *auditPlanInformer) Lister() v1alpha1.AuditPlanLister {
	return v1alpha1.NewAuditPlanLister(f.Informer().GetIndexer())
}
