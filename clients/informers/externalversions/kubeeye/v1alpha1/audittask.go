...
import (
	...
	v1alpha1 "github.com/kubesphere/kubeeye/clients/listers/kubeeye/v1alpha1"
...
type AuditTaskInformer interface {
	...
	Lister() v1alpha1.AuditTaskLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeeyeV1alpha1().AuditTasks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeeyeV1alpha1().AuditTasks(namespace).Watch(context.TODO(), options)
			},
		},
		&kubeeyev1alpha1.AuditTask{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *auditTaskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubeeyev1alpha1.AuditTask{}, f.defaultInformer)
}

func (f *auditTaskInformer) Lister() v1alpha1.AuditTaskLister {
	return v1alpha1.NewAuditTaskLister(f.Informer().GetIndexer())
}
