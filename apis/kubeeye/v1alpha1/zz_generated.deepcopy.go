...
func (in *AuditResult) DeepCopyInto(out *AuditResult) {
	*out = *in
	out.ClusterScore = in.ClusterScore
	if in.Results != nil {
		in, out := &in.Results, &out.Results
		*out = make([]ValidateResults, len(*in))
		for i := range *in {
...
func (in *ClusterInsightStatus) DeepCopyInto(out *ClusterInsightStatus) {
	*out = *in
	...
	in.AuditResults.DeepCopyInto(&out.AuditResults)
}
...
func (in *ResultInfos) DeepCopyInto(out *ResultInfos) {
	*out = *in
	if in.ResourceInfos != nil {
		in, out := &in.ResourceInfos, &out.ResourceInfos
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScoreReceiver) DeepCopyInto(out *ScoreReceiver) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScoreReceiver.
func (in *ScoreReceiver) DeepCopy() *ScoreReceiver {
	if in == nil {
		return nil
	}
	out := new(ScoreReceiver)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValidateResults) DeepCopyInto(out *ValidateResults) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValidateResults.
func (in *ValidateResults) DeepCopy() *ValidateResults {
	if in == nil {
		return nil
	}
	out := new(ValidateResults)
	in.DeepCopyInto(out)
	return out
}
