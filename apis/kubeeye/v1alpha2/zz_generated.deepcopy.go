...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileChangeResult) DeepCopyInto(out *FileChangeResult) {
	*out = *in
	if in.Info != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileChangeResult.
func (in *FileChangeResult) DeepCopy() *FileChangeResult {
	if in == nil {
		return nil
	}
	out := new(FileChangeResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InspectResultSpec) DeepCopyInto(out *InspectResultSpec) {
	*out = *in
	if in.FileChangeResult != nil {
		...
		*out = make([]FileChangeResult, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
