...
import (
	...
	kubeeye2 "github.com/kubesphere/kubeeye/client/informers/externalversions/kubeeye"
...
type SharedInformerFactory interface {
	...
	Kubeeye() kubeeye2.Interface
}

func (f *sharedInformerFactory) Kubeeye() kubeeye2.Interface {
	return kubeeye2.New(f, f.namespace, f.tweakListOptions)
}
